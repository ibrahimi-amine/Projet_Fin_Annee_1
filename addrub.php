  ...
  <div class="col-sm-9 col-md-8 col-lg-9 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">ajouter_rubrique</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['addrub']=="YES")
     {$_SESSION['addrub']="NO";
       ?><div class="alert alert-primary" role="alert">Rubrique ajouter <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Rubrique:</h3>
     <div class="col-12 col-sm-8 col-md-5 center_block">
        <form method="post" action="addrub.php" class="form-container2">
          <div class="form-group">
            <img src="img/addpers.png" class="rounded-circle center_img" style="width:100px; ">
          </div>
          <?php include('errorlogin.php'); ?>
          <div class="form-group">
             <label for="InputRubrique">Code Rubrique:</label>
             <input type="text" class="form-control" id="InputRubrique" name="InputRubrique"  placeholder="Enter Code">
          </div>
          <div class="form-group">
             <label for="InputDes">Designation :</label>
             <textarea type="text" class="form-control" cols="50" rows="10 "id="InputDes" name="InputDes"  placeholder="Enter Designation"></textarea>
          </div>
          <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="addrubbtn">Ajouter Rubrique</button>
          </div>
        </form>
      </div>
   </div>
