  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">chercheur</a></li>
        <li class="breadcrumb-item" aria-current="page"><a href="#">ajouter_chercheur</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['addpers']=="YES")
     {$_SESSION['addpers']="NO";
       ?><div class="alert alert-primary" role="alert">Chercheur Ajouter <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Chercheur :</h3>
     <div class="col-12 col-sm-8 col-md-6 center_block">
        <form method="post" action="addpers.php" class="form-container2">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-6">
                <label for="InputNom">Prenom & Nom :</label>
                <input type="text" class="form-control" id="InputNom" name="InputNom"  placeholder="Enter Nom">
              </div>
              <div class="col-6">
                <label for="InputEmail">Email address :</label>
                <input type="email" class="form-control disabled" id="InputEmail" name="InputEmail" aria-describedby="emailHelp" placeholder="Enter email">
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              <div class="col-4">
                ...
                <input type="text" class="form-control" id="InputEquipe" name="InputEquipe"  placeholder="Enter equipe">
              </div>
              <div class="col-4">
                <label for="InputLabo">Laboratoire :</label>
                <input type="text" class="form-control" id="InputLabo" name="InputLabo"  placeholder="Enter Laboratoire">
              </div>
              <div class="col-4">
                <label for="InputProjet">Projet :</label>
                <input type="text" class="form-control" id="InputProjet" name="InputProjet"  placeholder="Enter projet">
              </div>
            </div>
          </div>
          <div class="form-group ">
             <label for="InputGender">Select your gender :</label>
             <input type="radio" id="InputGender" name="InputGender" value="Male"><label for="InputGender">Male</label>
             <input type="radio" id="InputGender" name="InputGender" value="Female"><label for="InputGender">Female</label>
          </div>
          <div class="form-group">
             <label for="InputFunction">Select your Function :</label>
             <input type="radio" id="InputFunction" name="InputFunction" value="chercheur"><label for="InputFunction">Chercheur</label>
             <input type="radio" id="InputFunction" name="InputFunction" value="responsable"><label for="InputFunction">Responsable</label>
             <input type="radio" id="InputFunction" name="InputFunction" value="directeur"><label for="InputFunction">Directeur</label>
          </div>
          <div class="form-group">
             <label for="InputPassword2">Select image to upload :</label>
             <input type="file"  id="InputFile" name="InputFile" >
          </div>

            <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="creatbtn">Ajouter Chercheur</button>
            </div>
          </form>
         </div>
