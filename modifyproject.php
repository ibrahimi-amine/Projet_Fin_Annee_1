     ...
     <div class="row">
      <div class="col-sm-3 col-md-6 col-lg-4 col-xl-2">
        ...
        <ul class="list-group list-group-flush">
          ...
          <a id="personne" class="list-group-item list-group-item-action collapse disabled">Disabled</a>
          ...
          <a id="equipe" class="list-group-item list-group-item-action collapse disabled">Disabled</a>
          ...
          <a id="projet" class="list-group-item list-group-item-action collapse disabled">Disabled</a>
          ...
          <a id="budget" class="list-group-item list-group-item-action collapse disabled">Disabled</a>
  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">modifier_projet</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['mdfproject']=="YES")
     {$_SESSION['mdfproject']="NO";
       ?><div class="alert alert-primary" role="alert">Project Modifier <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Modifier Project :</h3>
     <div class="alert alert-primary" role="alert">Entrer information du Projet :</div>
     <?php if(!isset($_POST["checkmodifyprojbtn"]))
     {
     ?>
      <form method="post" action="modifyproject.php">
      ...
      {include('modifyproj.php');if(empty($error)){
      ?>
      <form method="post" action="modifyproject.php">
        <?php include('errorlogin.php'); ?>
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-5">
              <label for="InputNomproject">Titre Project :</label>
              <input type="text" class="form-control" id="InputNomproject" name="InputNomproject"  placeholder="<?php echo $_POST["InputNomproject"]?>" class="disabled">
            </div>
            <div class="col-5">
               <button type="submit" class="btn btn-primary disabled" name="checkmodifyprojbtn">Chercher Project</button>
           </div>
        </div>
       </div>
      </form>
      <div class="alert alert-primary" role="alert">Modifier les informations du Projet :</div>
      <form method="post" action="modifyproject.php">
        <div class="form-group">
           <label for="InputmdfNomproject">Nom Project:</label>
           <input type="text" class="form-control" id="InputmdfNomproject" name="InputmdfNomproject"  placeholder="<?php echo $donnee["nom_projet"]?>">
        </div>
        <div class="form-group ">
           <div class="row">
             <div class="col-6">
               <label for="InputmdfDatedebutproject">Entrer Date debut : (<?php echo $donnee["date_debutprojet"]?>)</label>
               <input type="date" class="form-control" id="InputmdfDatedebutproject" name="InputmdfDatedebutproject" >
             </div>
             <div class="col-6">
               <label for="InputmdfDatefinproject">Entrer Date fin : (<?php echo $donnee["date_finprojet"]?>)</label>
               <input type="date" class="form-control" id="InputmdfDatefinproject" name="InputmdfDatefinproject" >
            </div>
         </div>
        </div>
        <div class="form-group">
           <label for="InputmdfBudgetproject">Budget :</label>
           <input type="text" class="form-control" id="InputmdfBudgetproject" name="InputmdfBudgetproject" placeholder="<?php echo $donnee["budget"]?>" >
        </div>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-3"></div>
              <div class="col-3">
                <button type="submit" class="btn btn-danger center_block" name="cancelprojectbtn">cancel</button>
              </div>
              <div class="col-3">
                <button type="submit" class="btn btn-primary center_block" name="modifyprojectbtn">modify</button>
              </div>
              <div class="col-3"></div>
            </div>
          </div>
