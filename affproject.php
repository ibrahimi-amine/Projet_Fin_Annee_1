  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">afficher_projet</a></li>
      </ol>
    </nav>
    <div class="Nompersonne">Afficher  Project</div>
    <table class="table">
      <thead>
        <tr><th>Titre Project</th><th>Date debut</th><th>Date fin</th><th>Budget</th></tr>
      </thead>
      <tbody>
        <?php
         include('connectbdd.php');
         $reponse=$bd->query('SELECT * FROM Projet');
         while(!empty($donnee=$reponse->fetch()))
              {
        ?>
        <tr class="info">
          <td><?php echo $donnee['nom_projet']; ?></td>
          <td><?php echo $donnee['date_debutprojet']; ?></td>
          <td><?php echo $donnee['date_finprojet']; ?></td>
