  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">ajouter</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['addproject']=="YES")
     {$_SESSION['addproject']="NO";
       ?><div class="alert alert-primary" role="alert">Project Ajouter</div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Project :</h3>
     <div class="col-12 col-sm-8 col-md-5 center_block">
        <form method="post" action="addproject.php" class="form-container2">
          <div class="form-group">
            <img src="img/addpers.png" class="rounded-circle center_img" style="width:100px; ">
          </div>
          <?php include('errorlogin.php'); ?>
          <div class="form-group">
             <label for="InputNomproject">Nom Project:</label>
             <input type="text" class="form-control" id="InputNomproject" name="InputNomproject"  placeholder="Enter Nom project">
          </div>
          <div class="form-group ">
             <div class="row">
               <div class="col-6">
                 <label for="InputDatedebutproject">Entrer Date debut :</label>
                 <input type="date" class="form-control" id="InputDatedebutproject" name="InputDatedebutproject">
               </div>
               <div class="col-6">
                 <label for="InputDatefinproject">Entrer Date fin :</label>
                 <input type="date" class="form-control" id="InputDatefinproject" name="InputDatefinproject">
              </div>
           </div>
          </div>
          <div class="form-group">
             <label for="InputBudgetproject">Budget :</label>
             <input type="text" class="form-control" id="InputBudgetproject" name="InputBudgetproject" placeholder="Enter Budget" >
          </div>

            <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="creatprojectbtn">Ajouter project</button>
            </div>
          </form>
         </div>
