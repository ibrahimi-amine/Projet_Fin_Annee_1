  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">ajouter_equipe</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['addteam']=="YES")
     {$_SESSION['addteam']="NO";
       ?><div class="alert alert-primary" role="alert">Aquipe Ajouter </div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Equipe :</h3>
     <div class="col-12 col-sm-8 col-md-6 center_block">
        <form method="post" action="addteam.php" class="form-container2">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-6">
                <label for="InputNom">Nom Equipe :</label>
                <input type="text" class="form-control" id="InputNom" name="InputNom"  placeholder="Enter Nom">
              </div>
              <div class="col-6">
                <label for="Inputresp">Nom responsable equipe :</label>
                <input type="text" class="form-control disabled" id="Inputresp" name="Inputresp"  placeholder="Enter Nom rensponsable">
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-6">
                <label for="Inputdate">Date creation equipe :</label>
          ...
          <div class="form-group ">
            ...
            <textarea type="text" class="form-control" cols="50" rows="10 " id="InputDes" name="InputDes"  placeholder="Enter Designation"></textarea>

          </div>

            <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="addteambtn">Ajouter equipe</button>
            </div>
          </form>
         </div>
