  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">Supprimer</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['rmproject']=="YES")
     {$_SESSION['rmprojet']="NO";
       ?><div class="alert alert-primary" role="alert">Projet Supprimer <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Supprimer Projet :</h3>
     <div class="col-12 col-sm-8 col-md-3 center_block">
        <form method="post" action="rmproject.php" class="form-container2">
          <div class="form-group">
            <img src="img/rmpers.png" class="rounded-circle center_img" style="width:100px; ">
          </div>
          <?php include('errorlogin.php'); ?>
          <div class="form-group">
            <label for="InputNomprojet">Titre de projet :</label>
            <input type="text" class="form-control" id="InputNomprojet" name="InputNomprojet"  placeholder="Enter Titre">
          </div>
          <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="rmprojectbtn">Supprimer Project</button>
          </div>
        </form>
       </div>
