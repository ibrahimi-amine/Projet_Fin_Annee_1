...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-sm navbar-expand-md navbar-expand-lg navbar-expand-xl navbar-expand navbar-dark bg-primary">
      <a class="navbar-brand" href="#">Projet <?php $_SESSION['projet'];?></a>
  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
     <h3 class="Nompersonne">Ajouter Personne :</h3>
     <div class="col-12 col-sm-8 col-md-6 center_block">
        <form method="post" action="addpers.php" class="form-container2">
          <div class="form-group">
            <img src="img/addpers.png" class="rounded-circle center_img" style="width:120px; ">
          </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="creatbtn">Ajouter Personne</button>
            </div>
          </form>
         </div>
