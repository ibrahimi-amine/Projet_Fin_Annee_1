  ...
  <div class="col-sm-9 col-md-8 col-lg-9 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">addbudgetprojet</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['addbudgetproj']=="YES")
     {$_SESSION['addbudgetproj']="NO";
       ?><div class="alert alert-primary" role="alert">Budget Ajouter <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Budget de Projet:</h3>
     <div class="col-12 col-sm-8 col-md-5 center_block">
        <form method="post" action="addbudgetproj.php" class="form-container2">
          <div class="form-group">
            <img src="img/addpers.png" class="rounded-circle center_img" style="width:100px; ">
          </div>
          <?php include('errorlogin.php'); ?>
          <div class="form-group">
             <label for="Inputidbudgetproj">Id Budget:</label>
             <input type="text" class="form-control" id="Inputidbudgetproj" name="Inputidbudgetproj"  placeholder="Enter Id budget">
          </div>
          <div class="form-group">
             <label for="Inputnomproj">Titre Projet:</label>
             <input type="text" class="form-control" id="Inputnomproj" name="Inputnomproj"  placeholder="Enter Titre">
          </div>
          <div class="form-group ">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="addbudgprojectbtn">Ajouter Budget</button>
            </div>
          </form>
         </div>
