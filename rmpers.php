  ...
  <div class="col-sm-9 col-md-6 col-lg-8 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">Supperimer_Chercheur</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['rmpers']=="YES")
     {$_SESSION['rmpers']="NO";
       ?><div class="alert alert-primary" role="alert">Chercheur Supprimer <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Supprimer Chercheur :</h3>
     <div class="col-12 col-sm-8 col-md-6 center_block">
        <form method="post" action="rmpers.php" class="form-container2">
          <div class="form-group">
            <img src="img/rmpers.png" class="rounded-circle center_img" style="width:100px; ">
          </div>
          ...
          <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="rmbtn">Supprimer Chercheur</button>
          </div>
        </form>
       </div>
