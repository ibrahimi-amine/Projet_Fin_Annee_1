  ...
  <div class="col-sm-9 col-md-8 col-lg-9 col-xl-10">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item" aria-current="page"><a href="#">ajouter_depense</a></li>
      </ol>
    </nav>
    <?php if($_SESSION['adddep']=="YES")
     {$_SESSION['adddep']=="NO"
       ?><div class="alert alert-primary" role="alert">Depense Ajouter <a href="#" class="alert-link">link</a></div>
     <?php }?>
     <h3 class="Nompersonne">Ajouter Depense :</h3>
     <div class="col-12 col-sm-8 col-md-5 center_block">
        <form method="post" action="adddep.php" class="form-container2">
          ...
          <div class="form-group">
            <div class="row">
              <div class="col-6">
                ...
                <input type="text" class="form-control" id="InputNpe" name="InputNpe"  placeholder="Enter N PE">
              </div>
              <div class="col-6">
                <label for="InputCoderub">Code Rubrique :</label>
                <input type="text" class="form-control" id="InputCoderub" name="InputCoderub" placeholder="Enter Code Rubrique" >
              </div>
            </div>
          </div>
          <div class="form-group">
            <label for="InputNdepence">N Depense :</label>
            <input type="text" class="form-control" id="InputNdepence" name="InputNdepence" placeholder="Enter N Depense">
          </div>
          <div class="form-group ">
             <label for="InputDesc">Description :</label>
             <input type="text" class="form-control" id="InputDesc" name="InputDesc" placeholder="Enter Description">
         </div>
          <div class="form-group">
             <label for="InputMontant">Montant :</label>
             <input type="text" class="form-control" id="InputMontant" name="InputMontant"  placeholder="Enter Montant">
          </div>
          <div class="form-group">
              <button type="submit" class="btn btn-primary center_block" name="adddepbtn">Ajouter Depense</button>
          </div>
      </form>
     </div>
